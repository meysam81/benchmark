...
encode_msg(Msg, Opts) ->
    ...
    case Msg of
      #'my_app.sample.func.Fact'{} ->
	  'e_msg_my_app.sample.func.Fact'(Msg);
      #'my_app.sample.type.FactResp'{} ->
	  'e_msg_my_app.sample.type.FactResp'(Msg);
      #'my_app.sample.func.Ping'{} ->
	  'e_msg_my_app.sample.func.Ping'(Msg);
...
'e_msg_my_app.sample.func.Fact'(#'my_app.sample.func.Fact'{'N'
							       = F1},
				Bin) ->
...
'e_msg_my_app.sample.func.Ping'(_Msg) -> <<>>.
...
decode_msg(Bin, MsgName) when is_binary(Bin) ->
    case MsgName of
      'my_app.sample.func.Fact' ->
	  'd_msg_my_app.sample.func.Fact'(Bin);
      'my_app.sample.type.FactResp' ->
	  'd_msg_my_app.sample.type.FactResp'(Bin);
      'my_app.sample.func.Ping' ->
	  'd_msg_my_app.sample.func.Ping'(Bin);
      'my_app.sample.type.Pong' ->
...
'd_msg_my_app.sample.func.Fact'(Bin) ->
    'dfp_read_field_def_my_app.sample.func.Fact'(Bin, 0, 0,
						 id(undefined)).

'dfp_read_field_def_my_app.sample.func.Fact'(<<8,
					       Rest/binary>>,
					     Z1, Z2, F1) ->
    'd_field_my_app.sample.func.Fact_N'(Rest, Z1, Z2, F1);
'dfp_read_field_def_my_app.sample.func.Fact'(<<>>, 0, 0,
					     F1) ->
    #'my_app.sample.func.Fact'{'N' = F1};
'dfp_read_field_def_my_app.sample.func.Fact'(Other, Z1,
					     Z2, F1) ->
    'dg_read_field_def_my_app.sample.func.Fact'(Other, Z1,
						Z2, F1).

'dg_read_field_def_my_app.sample.func.Fact'(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, F1)
    when N < 32 - 7 ->
    'dg_read_field_def_my_app.sample.func.Fact'(Rest, N + 7,
						X bsl N + Acc, F1);
'dg_read_field_def_my_app.sample.func.Fact'(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc, F1) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  'd_field_my_app.sample.func.Fact_N'(Rest, 0, 0, F1);
      _ ->
	  case Key band 7 of
	    0 ->
		'skip_varint_my_app.sample.func.Fact'(Rest, 0, 0, F1);
	    1 -> 'skip_64_my_app.sample.func.Fact'(Rest, 0, 0, F1);
	    2 ->
		'skip_length_delimited_my_app.sample.func.Fact'(Rest, 0,
								0, F1);
	    5 -> 'skip_32_my_app.sample.func.Fact'(Rest, 0, 0, F1)
	  end
    end;
'dg_read_field_def_my_app.sample.func.Fact'(<<>>, 0, 0,
					    F1) ->
    #'my_app.sample.func.Fact'{'N' = F1}.

'd_field_my_app.sample.func.Fact_N'(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F1)
    when N < 57 ->
    'd_field_my_app.sample.func.Fact_N'(Rest, N + 7,
					X bsl N + Acc, F1);
'd_field_my_app.sample.func.Fact_N'(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, _) ->
    <<NewFValue:32/signed-native>> = <<(X bsl N +
					  Acc):32/unsigned-native>>,
    'dfp_read_field_def_my_app.sample.func.Fact'(Rest, 0, 0,
						 NewFValue).


'skip_varint_my_app.sample.func.Fact'(<<1:1, _:7,
					Rest/binary>>,
				      Z1, Z2, F1) ->
    'skip_varint_my_app.sample.func.Fact'(Rest, Z1, Z2, F1);
'skip_varint_my_app.sample.func.Fact'(<<0:1, _:7,
					Rest/binary>>,
				      Z1, Z2, F1) ->
    'dfp_read_field_def_my_app.sample.func.Fact'(Rest, Z1,
						 Z2, F1).


'skip_length_delimited_my_app.sample.func.Fact'(<<1:1,
						  X:7, Rest/binary>>,
						N, Acc, F1)
    when N < 57 ->
    'skip_length_delimited_my_app.sample.func.Fact'(Rest,
						    N + 7, X bsl N + Acc, F1);
'skip_length_delimited_my_app.sample.func.Fact'(<<0:1,
						  X:7, Rest/binary>>,
						N, Acc, F1) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_my_app.sample.func.Fact'(Rest2, 0,
						 0, F1).


'skip_32_my_app.sample.func.Fact'(<<_:32, Rest/binary>>,
				  Z1, Z2, F1) ->
    'dfp_read_field_def_my_app.sample.func.Fact'(Rest, Z1,
						 Z2, F1).


'skip_64_my_app.sample.func.Fact'(<<_:64, Rest/binary>>,
				  Z1, Z2, F1) ->
    'dfp_read_field_def_my_app.sample.func.Fact'(Rest, Z1,
						 Z2, F1).
...
'd_msg_my_app.sample.func.Ping'(Bin) ->
    'dfp_read_field_def_my_app.sample.func.Ping'(Bin, 0, 0).

'dfp_read_field_def_my_app.sample.func.Ping'(<<>>, 0,
					     0) ->
    #'my_app.sample.func.Ping'{};
'dfp_read_field_def_my_app.sample.func.Ping'(Other, Z1,
					     Z2) ->
    'dg_read_field_def_my_app.sample.func.Ping'(Other, Z1,
						Z2).

'dg_read_field_def_my_app.sample.func.Ping'(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc)
    when N < 32 - 7 ->
    'dg_read_field_def_my_app.sample.func.Ping'(Rest, N + 7,
						X bsl N + Acc);
'dg_read_field_def_my_app.sample.func.Ping'(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 -> 'skip_varint_my_app.sample.func.Ping'(Rest, 0, 0);
      1 -> 'skip_64_my_app.sample.func.Ping'(Rest, 0, 0);
      2 ->
	  'skip_length_delimited_my_app.sample.func.Ping'(Rest, 0,
							  0);
      5 -> 'skip_32_my_app.sample.func.Ping'(Rest, 0, 0)
    end;
'dg_read_field_def_my_app.sample.func.Ping'(<<>>, 0,
					    0) ->
    #'my_app.sample.func.Ping'{}.

'skip_varint_my_app.sample.func.Ping'(<<1:1, _:7,
					Rest/binary>>,
				      Z1, Z2) ->
    'skip_varint_my_app.sample.func.Ping'(Rest, Z1, Z2);
'skip_varint_my_app.sample.func.Ping'(<<0:1, _:7,
					Rest/binary>>,
				      Z1, Z2) ->
    'dfp_read_field_def_my_app.sample.func.Ping'(Rest, Z1,
						 Z2).


'skip_length_delimited_my_app.sample.func.Ping'(<<1:1,
						  X:7, Rest/binary>>,
						N, Acc)
    when N < 57 ->
    'skip_length_delimited_my_app.sample.func.Ping'(Rest,
						    N + 7, X bsl N + Acc);
'skip_length_delimited_my_app.sample.func.Ping'(<<0:1,
						  X:7, Rest/binary>>,
						N, Acc) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_my_app.sample.func.Ping'(Rest2, 0,
						 0).


'skip_32_my_app.sample.func.Ping'(<<_:32, Rest/binary>>,
				  Z1, Z2) ->
    'dfp_read_field_def_my_app.sample.func.Ping'(Rest, Z1,
						 Z2).


'skip_64_my_app.sample.func.Ping'(<<_:64, Rest/binary>>,
				  Z1, Z2) ->
    'dfp_read_field_def_my_app.sample.func.Ping'(Rest, Z1,
						 Z2).
...
merge_msgs(Prev, New)
    ...
    case Prev of
      #'my_app.sample.func.Fact'{} ->
	  'merge_msg_my_app.sample.func.Fact'(Prev, New);
      #'my_app.sample.type.FactResp'{} ->
	  'merge_msg_my_app.sample.type.FactResp'(Prev, New);
      #'my_app.sample.func.Ping'{} ->
	  'merge_msg_my_app.sample.func.Ping'(Prev, New);
      #'my_app.sample.type.Pong'{} ->
	  'merge_msg_my_app.sample.type.Pong'(Prev, New)
    end.

'merge_msg_my_app.sample.func.Fact'(#'my_app.sample.func.Fact'{'N'
								   = PFN},
				    #'my_app.sample.func.Fact'{'N' = NFN}) ->
    #'my_app.sample.func.Fact'{'N' =
...
'merge_msg_my_app.sample.func.Ping'(_Prev, New) -> New.
...
verify_msg(Msg) ->
    case Msg of
      #'my_app.sample.func.Fact'{} ->
	  'v_msg_my_app.sample.func.Fact'(Msg,
					  ['my_app.sample.func.Fact']);
      #'my_app.sample.type.FactResp'{} ->
	  'v_msg_my_app.sample.type.FactResp'(Msg,
					      ['my_app.sample.type.FactResp']);
      #'my_app.sample.func.Ping'{} ->
	  'v_msg_my_app.sample.func.Ping'(Msg,
					  ['my_app.sample.func.Ping']);
      #'my_app.sample.type.Pong'{} ->
...
'v_msg_my_app.sample.func.Fact'(#'my_app.sample.func.Fact'{'N'
							       = F1},
				Path) ->
    v_type_int32(F1, ['N' | Path]), ok.
...
'v_msg_my_app.sample.func.Ping'(#'my_app.sample.func.Ping'{},
				_Path) ->
    ok.
...
get_msg_defs() ->
    [{{msg, 'my_app.sample.func.Fact'},
      [#field{name = 'N', fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, 'my_app.sample.type.FactResp'},
      [#field{name = resp, fnum = 1, rnum = 2, type = int32,
	      occurrence = required, opts = []}]},
     {{msg, 'my_app.sample.func.Ping'}, []},
...
get_msg_names() ->
    ['my_app.sample.func.Fact',
     'my_app.sample.type.FactResp',
     'my_app.sample.func.Ping', 'my_app.sample.type.Pong'].
...
find_msg_def('my_app.sample.func.Fact') ->
    [#field{name = 'N', fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def('my_app.sample.type.FactResp') ->
    [#field{name = resp, fnum = 1, rnum = 2, type = int32,
	    occurrence = required, opts = []}];
find_msg_def('my_app.sample.func.Ping') -> [];
...
get_package_name() -> 'my_app.sample.func'.
